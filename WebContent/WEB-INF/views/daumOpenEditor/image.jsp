...
<script type="text/javascript">
	...
	function done(fileInfo) //*fileInfo 를 파라미터로 등록해줘야함
	{
		...
		PopupUtil.getOpener().document.getElementById("imageurl").value=_mockdata['imageurl']; 
		PopupUtil.getOpener().document.getElementById("filename").value=_mockdata['filename'];
		PopupUtil.getOpener().document.getElementById("filesize").value=_mockdata['filesize'];
		PopupUtil.getOpener().document.getElementById("originalurl").value=_mockdata['originalurl'];
		PopupUtil.getOpener().document.getElementById("path").value=_mockdata['path'];
		PopupUtil.getOpener().document.getElementById("originalName").value=_mockdata['originalName'];
		closeWindow();
	}
